...
<definitions xmlns:soap="http://schemas.xmlsoap.org/wsdl/soap/"
             ...
             xmlns:tns="https://soap-kasatkin.c9users.io/"
    ...
    <types>
        <xs:schema elementFormDefault="qualified"
                   ...
                   xmlns:xs="http://www.w3.org/2001/XMLSchema"
                   targetNamespace="https://soap-kasatkin.c9users.io/">
    ...
    <service name="SmsService">
        <port name="SmsServicePort" binding="tns:SmsServiceBinding">
            <soap:address location="https://soap-kasatkin.c9users.io/smsservice.php" />
        </port>
    </service>
</definitions>